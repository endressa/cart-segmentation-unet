...
PSEUDO_MASK_ROOT = Path("~/sarah/background_segmentation/dataset/pseudo_masks_2_cleaned").expanduser()
...
CHECKPOINT_PATH = Path("~/sarah/background_segmentation/checkpoints_pretrained/pseudo_model_15.pth").expanduser()
